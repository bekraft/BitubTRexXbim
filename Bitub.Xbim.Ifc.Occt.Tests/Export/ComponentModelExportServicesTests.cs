...
[TestFixture]
public class ComponentModelExportServicesTests : TRexWithGeometryServicesTest<ComponentModelExportServicesTests>
{
    ...
    private Task<ComponentScene> RunIfc4Export(string resourceName, ScenePreferences settings)
        => RunExport(resourceName, settings, ReadIfcModel);
