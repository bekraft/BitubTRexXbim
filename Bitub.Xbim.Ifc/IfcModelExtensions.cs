...
namespace Bitub.Xbim.Ifc
{
    public static class IfcModelExtensions
    {
        ...
        public static IIfcRelAggregates NewDecomposes(this IModel s, IIfcObjectDefinition host)
        {
            ...
            {
                case XbimSchemaVersion.Ifc2X3:
                    return s.NewIfc2x3Decomposes(host as global::Xbim.Ifc2x3.Kernel.IfcObjectDefinition);
                case XbimSchemaVersion.Ifc4:
                case XbimSchemaVersion.Ifc4x1:
                    return s.NewIfc4Decomposes(host as global::Xbim.Ifc4.Kernel.IfcObjectDefinition);
            }
            throw new NotImplementedException($"Not implemented schema version ${s.SchemaVersion}");
        }
        ...
        public static IIfcRelContainedInSpatialStructure NewContains(this IModel s, IIfcSpatialStructureElement e)
        {
            ...
            {
                case XbimSchemaVersion.Ifc2X3:
                    return s.NewIfc2x3Contains(e as global::Xbim.Ifc2x3.ProductExtension.IfcSpatialStructureElement);
                case XbimSchemaVersion.Ifc4:
                case XbimSchemaVersion.Ifc4x1:
                    return s.NewIfc4Contains(e as global::Xbim.Ifc4.ProductExtension.IfcSpatialStructureElement);
            }
            throw new NotImplementedException($"Not implemented schema version ${s.SchemaVersion}");
        }
        ...
        {   
            switch(s.SchemaVersion)
            {
                ...
                case XbimSchemaVersion.Ifc4:
                case XbimSchemaVersion.Ifc4x1:
                    return s.Instances.New<global::Xbim.Ifc4.MeasureResource.IfcSIUnit>(x =>
                    {
                        x.Name = name;
                        x.Prefix = prefix;
                        x.UnitType = unitType;
        ...
        public static IIfcRelDefinesByProperties NewIfcRelDefinesByProperties(this IModel s, IIfcPropertySetDefinitionSelect set)
        {
            switch (s.SchemaVersion)
            {
                ...
                case XbimSchemaVersion.Ifc4:
                case XbimSchemaVersion.Ifc4x1:
                    return s.NewIfc4PropertyRelation(set as global::Xbim.Ifc4.Kernel.IfcPropertySetDefinitionSelect);
                default:
                    throw new NotImplementedException($"Missing implementation for {s.SchemaVersion}");
            }
        }
        ...
        public static IIfcRelDefinesByProperties NewIfcRelDefinesByProperties(this IModel s, IIfcPropertySet set)
        {
            ...
            {
                case XbimSchemaVersion.Ifc2X3:
                    return s.NewIfc2x3PropertyRelation(set as global::Xbim.Ifc2x3.Kernel.IfcPropertySet);
                case XbimSchemaVersion.Ifc4:
                case XbimSchemaVersion.Ifc4x1:
                    return s.NewIfc4PropertyRelation(set as global::Xbim.Ifc4.Kernel.IfcPropertySet);
                default:
                    throw new NotImplementedException($"Missing implementation for {s.SchemaVersion}");
            }
        }
