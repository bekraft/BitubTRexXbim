...
namespace Bitub.Xbim.Ifc.Transform
{
    public static class XbimExtensions
    {
        ...
        public static IEnumerable<global::Xbim.Ifc4.MeasureResource.IfcReal> ToIfcReal4(this XbimVector3D v)
        {
            return new global::Xbim.Ifc4.MeasureResource.IfcReal[] { v.X, v.Y, v.Z };
        }
        ...
        public static IEnumerable<global::Xbim.Ifc4.MeasureResource.IfcLengthMeasure> ToIfcLengthMeasure4(this XbimVector3D v, double scale = 1.0)
        {
            return new global::Xbim.Ifc4.MeasureResource.IfcLengthMeasure[] { v.X * scale, v.Y * scale, v.Z * scale };
        }
        ...
        public static IEnumerable<global::Xbim.Ifc4.MeasureResource.IfcLengthMeasure> ToIfcLengthMeasure4(this XbimVector3D v, IModelFactors f)
        {
            return new global::Xbim.Ifc4.MeasureResource.IfcLengthMeasure[]
            {
                PrecisionClamp(v.X, f.OneMeter, f.Precision),
                PrecisionClamp(v.Y, f.OneMeter, f.Precision),
                PrecisionClamp(v.Z, f.OneMeter, f.Precision)
        ...
        public static IEnumerable<global::Xbim.Ifc2x3.MeasureResource.IfcReal> ToIfcReal2x3(this XbimVector3D v)
        {
            return new global::Xbim.Ifc2x3.MeasureResource.IfcReal[] { v.X, v.Y, v.Z };
        }
        ...
        /// <param name="scale">The model scale</param>
        /// <returns>Scaled length measure values</returns>
        public static IEnumerable<global::Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure> ToIfcLengthMeasure2x3(this XbimVector3D v, double scale = 1.0)
        {
            return new global::Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure[] { v.X * scale, v.Y * scale, v.Z * scale };
        }
        ...
        /// <param name="f">The model factors</param>
        /// <returns>Length measure values in compliance to the model length unit</returns>
        public static IEnumerable<global::Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure> ToIfcLengthMeasure2x3(this XbimVector3D v, IModelFactors f)
        {
            return new global::Xbim.Ifc2x3.MeasureResource.IfcLengthMeasure[]
            {
                PrecisionClamp(v.X, f.OneMeter, f.Precision),
                PrecisionClamp(v.Y, f.OneMeter, f.Precision),
                PrecisionClamp(v.Z, f.OneMeter, f.Precision)
