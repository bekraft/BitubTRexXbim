...
{
    internal static readonly XmlSerializer serializer = new XmlSerializer(typeof(IfcAxisAlignment));
    ...
    public IIfcLocalPlacement ChangeIfcLocalPlacement(IIfcLocalPlacement placement, XbimMatrix3D transform)
    {
        ...
        {
            case XbimSchemaVersion.Ifc2X3:
                return (placement as global::Xbim.Ifc2x3.GeometricConstraintResource.IfcLocalPlacement).ChangeIfc2x3ObjectPlacementTo(finalAlignment, true);
            case XbimSchemaVersion.Ifc4:
            case XbimSchemaVersion.Ifc4x1:
                return (placement as global::Xbim.Ifc4.GeometricConstraintResource.IfcLocalPlacement).ChangeIfc4ObjectPlacementTo(finalAlignment, true);
            default:
